        ...
        >
              ...
              {/* back btn  */}
                        ...
                        <div className='hauls--bg--img top-[40%]'>
                            {/* hauls big image */}
                            <img loading='lazy' className='min-w-[195px] max-w-[195px] h-[555px] mx-auto laptop:max-w-[250] laptop:h-[600px] laptop:mt-[2rem]' src={diyBg} alt='hauls--img' />
...
export const GrwmCreateContent = () => ( 
    <>
    </>
);

export const GrwmEditContent = () => (
    <>
    </>
);


export const GrwmShowContent = () => (
    <Signlepost />
);