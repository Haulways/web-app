...
import { InfiniteList, WithListContext, useGetList, useStore } from 'react-admin';
...
const Fashion = () => {
  ...
  const [ra_products, setRa_Products] = React.useState(null);
    ...
    <>
      <div className="pt-[1rem] pb-[4rem]">
        <div className="mb-[1.5rem]">
          <h2 className="text-[18px]  font-[600] px-[.7rem] mb-[.5rem]">Fashion</h2>
          {/* Search box */}
          <div
