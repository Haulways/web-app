...
import { FormTab, InfiniteList, Tab, TabbedForm, TabbedShowLayout, WithListContext, useGetList, useRecordContext, useStore } from 'react-admin';
				...
				<div className="pb-[10px] px-[14px] ">
					...
					<div className="flex flex-col items-center  mx-auto">
						...
						<p className="font-[500] text-[14px] ">
							Fill this form to create your Store
						</p>
					</div>
				</div>
			</div>
