...
const ShippingAddress = ({ open, close, order }: Props) => {
                  ...
                  <div className="flex flex-col col-span-1 space-y-1">
                    ...
                    <span className="bg-gray-100 overflow-hidden rounded">
                      <Input
                        ...
                        defaultValue={order?.shipping_address?.address_1 ?? ""}
                      />
                    </span>
                  </div>
                  <div className="flex flex-col col-span-1 space-y-1">
                    ...
                    <span className="bg-gray-100 overflow-hidden rounded">
                      <Input
                        ...
                        defaultValue={order?.shipping_address?.address_2 ?? ""}
                      />
                    </span>
                  </div>
                </section>
                ...
                <section className="grid grid-cols-2 grid-flow-row gap-3 w-full">
                  <div className="flex flex-col col-span-1 space-y-1">
                    ...
                    <span className="bg-gray-100 overflow-hidden rounded">
                      <Input
                        placeholder="0000"
                        defaultValue={order?.shipping_address?.province ?? ""}
                      />
                    </span>
                  </div>
                  <div className="flex flex-col col-span-1 space-y-1">
