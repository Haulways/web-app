...
import '../../components/profile/stat.css';
...
import { InfiniteList, ListBase, Title, WithListContext } from 'react-admin';
...
const AdStat = () => {
    ...
    return (
        <>
            <Title className='font-[500] text-[16px]' title='Ad Stats' />
            <div className='feed--page max-w-[95vw] px-[.5rem] pt-[2rem]'>
                <UserStat theme={theme} />
                <div className='mt-[31px] mx-auto flex overflow-x-scroll store__card  gap-x-6 pb-[5px] px-[.5rem]'>
        ...
        <>
            ...
            >
                ...
                <div className='flex items-center justify-center gap-x-[10px]'>
                    ...
                    <div className='grid grid-cols-2 w-full gap-x-[15px] gap-y-[20px] items-center'>
