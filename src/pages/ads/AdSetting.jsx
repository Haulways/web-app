...
import { Title, useDataProvider, useGetList,  useRedirect } from 'react-admin';
import CameraAltIcon from '@mui/icons-material/CameraAlt';
import { ThemeContext } from '../../components/context/ThemeProvider';
import AdFooter from './AdActions';
...
const AdSetting = () => {
  ...
  // const tables = ["posts", "hauls", "lookbook", "diy", "grwm", "users"];
  ...
  //   const searchResults = fullTextSearch();
...
// </div>
  ...
  return (
		<>
			<Title title="Ad Settings" className="font-[500] text-[16px]" />
				...
				<div className="feed--page">
					<ul className="user__dropdown">
						...
						<li className="settings">
							<div>
								<MdArrowBackIos
									className="cursor-pointer laptop:hidden tablet:hidden absolute left-[1rem] top-[5rem]"
									size={20}
									onClick={() => navigate(-1)}
								/>
							</div>
							...
							<div className="flex gap-x-[8px] items-center">
								<div className="uImage--container">
									...
									<Link to={`/users/${userData?.id}/edit`}>
										<img
											className="absolute top-[70%] right-[0] w-[20px] h-[20px] rounded-full"
											src={camera}
											alt="camera"
										/>
									</Link>
						...
						{/* account center */}
						<div
							className=" mt-[2rem] flex justify-between items-center cursor-pointer"
							onClick={openAccount}
						>
						...
						>
							<div className="flex gap-x-[18px] items-center w-[100%]">
								...
								<div className="pl-[5px]">
									...
									<p className=" font-[400] text-[14px]">Logout, add account</p>
								</div>
							</div>
						...
						>
							<div className="flex gap-x-[18px] items-center w-[100%]">
								...
								<div className="pl-[5px]">
									...
									<p className=" font-[400] text-[14px]  ">Requests, updates</p>
								</div>
							</div>
