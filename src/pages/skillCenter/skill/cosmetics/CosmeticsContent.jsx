...
export const CosmeticsListContent = () => {
        ...
        <>
            <div className="relative  feed--page">
                ...
                <div className="pb-[30px] px-[8px] pt-[3.5rem]">
                    {/* Hauls Heading */}
                    <div className=' '>
                        <h2 className='font-[500] text-[14px] leading-[20px]'>Cosmetics</h2>
        ...
        <WithListContext render={({ isLoading, data }) => (
            ...
            !isLoading ? (
                <div className=" feed--page ">
                        ...
                        {data?.sort((a, b) => b.timestamp - a.timestamp).filter(post => post.categories.includes('cosmetics')).map((post) => {
...
export const CosmeticsCreateContent = () => ( 
    <Create>
        <CreatePost title='Course' collectionName="courses"/>
    </Create>
);

export const CosmeticsEditContent = () => (
    <EditGuesser />
);


export const CosmeticsShowContent = () => {
    return (
