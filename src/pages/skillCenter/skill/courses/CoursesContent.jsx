        ...
        <>
            <div className="relative  feed--page">
                ...
                <div className="pb-[30px] px-[8px] pt-[3.5rem]">
                    {/* Hauls Heading */}
                    <div className=' '>
                        <h2 className='font-[500] text-[14px] leading-[20px]'>All</h2>
        ...
        <WithListContext render={({ isLoading, data }) => (
            ...
            !isLoading ? (
                <div className=" feed--page ">
                        ...
                        {data?.sort((a, b) => b.timestamp - a.timestamp).map((post) => {
                            ...
                            return (
                                ...
                                <div key={post.id} className='w-[100%] relative pt-[10px]' >
                                    ...
                                    <div className='flex justify-between mt-[10px]'>
                                        <div>
                                            <p className='text-[10px] body laptop:text-[15px]'>{post.body}</p>
...
export const CoursesCreateContent = () => ( 
    <Create>
        <CreatePost title='Course' collectionName="courses"/>
    </Create>
);

export const CoursesEditContent = () => (
    <EditGuesser />
);


export const CoursesShowContent = () => {
    return (
