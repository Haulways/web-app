...
export const MakeupListContent = () => {
        ...
        <>
            <div className="relative  feed--page">
                ...
                <div className="pb-[30px] px-[8px] pt-[3.5rem]">
                    {/* Hauls Heading */}
                    <div className=' '>
                        <h2 className='font-[500] text-[14px] leading-[20px]'>Makeup</h2>
        ...
        <WithListContext render={({ isLoading, data }) => (
            ...
            !isLoading ? (
                <div className=" feed--page ">
                        ...
                        {data?.sort((a, b) => b.timestamp - a.timestamp).filter(post => post.categories.includes('makeup')).map((post) => {
                                            ...
                                            <>
                                                ...
                                                <div className='absolute bg-[#222] p-[2px] right-[7px]  bottom-[7px] rounded-[2px] flex items-center gap-x-[2px] text-[5px] text-white'>
                                                    <svg xmlns="http://www.w3.org/2000/svg" width="8" height="6" viewBox="0 0 8 6" fill="none">
                                                        ...
                                                        <path d="M3.59462 3.30078H1M3.59462 4.59809H1" stroke="white" strokeWidth="0.5" stroke-linecap="round" />
                                                        ...
                                                        <path d="M1 0.707031H4.40544M6.51358 0.707031H5.78384M6.51358 2.00434H3.10813M1 2.00434H1.72974" stroke="white" strokeWidth="0.5" stroke-linecap="round" />
                                                    </svg>
                                                    <p>10</p>
                                                </div>
                                            </>
...
export const MakeupCreateContent = () => ( 
    <Create>
        <CreatePost title='Course' collectionName="courses"/>
    </Create>
);

export const MakeupEditContent = () => (
    <EditGuesser />
);


export const MakeupShowContent = () => {
    return (
