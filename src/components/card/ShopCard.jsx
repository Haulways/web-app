...
export const ShopCard = ({ data }) => {
    ...
    return (
        <>
            <Card className='mobile:w-[95vw]  tablet:max-w-[600px] laptop:max-w-[1000px] laptop:px-[1rem] ' sx={{ boxShadow: 'none', backgroundColor: theme === "light" ? "#fff" : "#222", marginTop: '20px', color: theme === "light" ? "#222" : "#fff", }}>
                    ...
                    {data && data.map((post) => {
                        ...
                        return (
                            <React.Fragment key={post.id}>
                                <Link to={post && post.id !== null ? (`/store/${post.id}/show`) : (null)}>
                                    <Card className='rounded-[10px] pt-2 pb-0 my-5' sx={{ minWidth: 310, boxShadow: 'none', backgroundColor: theme === "light" ? "#eee" : "rgba(68, 68, 68, 0.2)", color: theme === "light" ? "#222" : "#fff", }}>
                                        ...
                                        <div className='w-full h-[50px]  youtube--container overflow-hidden rounded-t-[10px] relative'>
                                        ...
                                        <CardContent sx={{ height: 50, backgroundColor: theme === "light" ? "#222" : "rgba(68, 68, 68, 0.2)", color: theme === "light" ? "#fff" : "#fff", }} className='flex items-center w-full justify-between pt-2 rounded-[10px]'>
