...
function VideoTrimmer({ selectedfiles, activeFile, collectionName, taggedData, setSelectedFiles, theme }) {
...
export const CoverPhoto = ({ coverPhoto, closeCoverPhoto, selectedfiles, activeFile, thumbNails1, setThumbNails1, thumbnailIsProcessing1, setThumbnailIsProcessing1, currentThumbnailIndex1, setCurrentThumbnailIndex1, theme }) => {
    const [inputVideoFile, setInputVideoFile] = useState(null);
    const [videoMeta, setVideoMeta] = useState(null);
    const [URL, setURL] = useState([]);
    const [rStart, setRstart] = React.useState(0);
