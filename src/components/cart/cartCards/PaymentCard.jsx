...
export const CartPayment = ({ cart, openForm, SetPaymentSess, componentProps }) => {
    ...
    return (
        ...
        <>
            <div className='payment--details px-3' style={{
                ...
                <div className='payment-method'>
                    <Accordion className='cart--accordian before:h-0  mb-[10px]' sx={{ boxShadow: 'none' }} style={{
                        backgroundColor: theme === 'light' ? '#fff' : '#222',
                        color: theme === 'light' ? '#222' : '#fff',
                    }}>
...
export const BrandDetails = ({ store, cart }) => {
    ...
    return (
        <>
            <div className='payment--details bg-[#FAF9F9] rounded-[10px] mt-[25px] px-[15px]' style={{
                backgroundColor: theme === 'light' ? '#fff' : '#222',
                color: theme === 'light' ? '#222' : '#fff',
            }}>
